...
func FindInMapIf[A iterator.MapIndexer[K, V], K, V any](arr A, pred func(*types.Pair[K, V]) bool) (*types.Pair[K, V], bool) {
...
func MapForeach[S iterator.MapIndexer[K, V], K, V any](arr S, f func(*types.Pair[K, V])) {
	for i := 0; i < arr.Capacity(); i++ {
		f(&types.Pair[K, V]{
			Key:   arr.GetKeyFromIndex(i),
			Value: arr.GetFromIndex(i),
...
func FindInMap[I iterator.MapIndexer[K, V], K, V any](ref I, comp *types.Pair[K, V]) (*types.Pair[K, V], bool) {
	var (
		found = false
