...
// Type is a linked list of domain.Element that represents multiple types for the same field
...
func (t *Type) Assign(e *domain.Element) error {
...
func (t *Type) TransformToXML(buffer *encoder.Buffer) error {
